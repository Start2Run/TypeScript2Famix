...
export class mseClassHelper {
    ...
    public loadClass(classDeclaration: ClassDeclaration, sourceFileName: string, fmxNameSpace: Famix.Namespace = null) {
        var fmxFileAnchor = mseFileAnchorHelper.createFileAnchor(this._repository, sourceFileName, classDeclaration.getStart(), classDeclaration.getEnd())
    ...
    public loadInterface(interfaceDeclaration: InterfaceDeclaration, sourceFileName: string, fmxNameSpace: Famix.Namespace = null) {
        var fmxFileAnchor = mseFileAnchorHelper.createFileAnchor(this._repository, sourceFileName, interfaceDeclaration.getStart(), interfaceDeclaration.getEnd())
    ...
    private updateInfo(famixClass: Famix.Class, name: string, fmxFileAnchor: Famix.IndexedFileAnchor, isInterface: boolean, fmxNamespace?: Famix.Namespace) {
